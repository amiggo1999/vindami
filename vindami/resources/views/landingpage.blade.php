...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <nav class="bg-dark">
            <div class="top-nav nav-container">
                ...
                <ul>
                    ...
                    <li><a class="btn" href="{{ route('cart.store') }}"><i class="fas fa-shopping-cart"></i></a></li>
                </ul>
            </div>
        </nav>
        <!-- Header -->
        <header>
            <!-- Hero -->
            <div class="hero">
                <img src="img/Violette Spumante - FB-ad.png" alt="">
            </div>
        </header>
        <!-- Featured -->
            ...
            <div class="products container">
                @foreach($products as $product)
                    <div class="product">
                        ...
                        <a href="/shop/{{ $product->slug }}" class="btn-cart">Artikel ansehen</a>
                    </div>
                @endforeach
                <!-- End products -->
            </div>
